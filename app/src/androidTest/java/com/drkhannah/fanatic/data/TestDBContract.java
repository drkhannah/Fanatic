...
public class TestDBContract extends AndroidTestCase {
    ...
    private static final String TEST_SEARCH_ID = "1";
    ...
    public void testBuildEventListForSearchUri() {
        ...
        assertEquals("Error: Events for Search not properly appended to the end of the Uri", TEST_SEARCH_ID, searchUri.getLastPathSegment());
